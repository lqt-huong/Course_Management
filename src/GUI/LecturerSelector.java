 ...
 * @author Lộc
 */
public class LecturerSelector extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbLecturer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã giảng viên", "Họ", "Tên", "Ngày đăng ký"
            }
        ) {
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        ...
        try {
            listSearch=personbll.SearchLecturer(txSearch.getText());
        } catch (Exception ex) {
    ...
    private void btSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelectActionPerformed
        int i=tbLecturer.getSelectedRow();
        if(i<0){
            JOptionPane.showMessageDialog(null, "Chưa chọn giảng viên", "Chú ý!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }   
        try{
            ManageInstructor.setPersonID(String.valueOf(personbll.getList().get(i).getPersonID()));
        }
        catch (Exception ex){
            System.out.println("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LecturerSelector DepSel=new LecturerSelector();
                try {
                    DepSel.List();          
                } catch (Exception ex) { 
                    System.out.println(ex);
