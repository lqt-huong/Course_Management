 ...
 * @author Lộc
 */
public class OnlineCourseSelector extends javax.swing.JFrame {
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        ...
        try {
            listSearch=coursebll.SearchOnlineForSelect(txSearch.getText());
        } catch (Exception ex) {
    ...
    private void btSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelectActionPerformed
        int i=tbOnline.getSelectedRow();
        if(i<0){
            JOptionPane.showMessageDialog(null, "Chưa chọn học viên", "Chú ý!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }   
        try{
            ManageGrade.setOnlineCourseID(String.valueOf(coursebll.getListOnline().get(i).getCourseID()));
        }
        catch (Exception ex){
            ManageInstructor.setOnsiteCourseID(String.valueOf(coursebll.getListOnline().get(i).getCourseID()));
        }
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlineCourseSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OnlineCourseSelector DepSel=new OnlineCourseSelector();
                try {
                    DepSel.List();          
                } catch (Exception ex) { 
                    System.out.println(ex);
